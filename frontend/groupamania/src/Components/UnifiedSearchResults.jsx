...
import { FaUser, FaEnvelope, FaUsers, FaCrown } from 'react-icons/fa';
            ...
            return (
                <div className={styles.noResultsContainer}>
                    <div className="text-center">
                        ...
                        <h5 className="mt-3 text-muted">Aucun groupe trouvé</h5>
                        <p className="text-muted">Essayez avec d'autres mots-clés</p>
                    </div>
                </div>
            );
            ...
            <div className={styles.resultsContainer}>
                ...
                <div className={styles.usersList}>
                    {groups.map((group) => (
                        <Card 
                            key={group.id} 
                            className={`${styles.userCard} ${styles.groupCard}`}
                                ...
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className={styles.userInfo}>
                                        ...
                                        <div className="d-flex justify-content-between align-items-center small text-muted">
                                            <span>
                                                <strong>{group.memberCount || 0}</strong> membre{(group.memberCount || 0) !== 1 ? 's' : ''}
                                            </span>
                                            {group.leader && (
