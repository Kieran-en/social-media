...
export default function ModifyPostModal({ closeModal, postToModify, initialText, initialImage }) {
  ...
  return (
    <Backdrop closeModal={closeModal}>
      ...
      >
        {/* The <form> tag now wraps everything from the header to the footer */}
        <form onSubmit={handleSubmit} className="flex flex-col h-full">
          ...
          <div className="flex-grow p-6 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <input 
                ...
                name="image" 
                type="file" 
                accept="image/*,video/*" // Allow video as well, based on your Post component
                className="hidden" 
          ...
          {/* Pied de page avec les boutons d'action (NOW INSIDE THE FORM) */}
          <div className="flex justify-end gap-3 p-4 bg-gray-50 border-t border-gray-200 rounded-b-2xl">
            ...
            <button
              type="submit" // This now correctly submits the form
              disabled={isLoading}
